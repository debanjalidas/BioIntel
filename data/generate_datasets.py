...
raw_species_records = [
    ...
    ("Rhinoceros unicornis", "Greater One-Horned Rhinoceros", "Mammalia", "Rhinocerotidae", "Rhinoceros", "VU", "19496", False, True, "Alluvial grassland specialist and grazing architect.", "https://images.unsplash.com/photo-1574870115563-ced4f2766023?auto=format&fit=crop&w=800&q=80"),
    ...
    ("Ailurus fulgens", "Red Panda", "Mammalia", "Ailuridae", "Ailurus", "EN", "714", False, True, "Specialized subalpine bamboo forest dweller.", "https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=800&q=80"),
    ("Neofelis nebulosa", "Clouded Leopard", "Mammalia", "Felidae", "Neofelis", "VU", "14519", False, True, "Arboreal rainforest predator of primary evergreen forests.", "https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?auto=format&fit=crop&w=800&q=80"),
    ("Cuon alpinus", "Dhole / Asiatic Wild Dog", "Mammalia", "Canidae", "Cuon", "EN", "5929", False, True, "Social pack hunter vulnerable to habitat fragmentation and prey loss.", "https://images.unsplash.com/photo-1535268647677-300dbf3d78d1?auto=format&fit=crop&w=800&q=80"),
    ...
    ("Eudynamys scolopaceus", "Asian Koel", "Aves", "Cuculidae", "Eudynamys", "LC", "22684043", False, False, "Vocal brood parasite widespread in subtropical canopy.", "https://images.unsplash.com/photo-1549608276-5786777e6587?auto=format&fit=crop&w=800&q=80"),
    ...
    ("Nasikabatrachus sahyadrensis", "Purple Frog", "Amphibia", "Nasikabatrachidae", "Nasikabatrachus", "EN", "58479", False, True, "Living fossil subterranean frog emerging only during monsoon.", "https://images.unsplash.com/photo-1579380656108-328e1a387cb0?auto=format&fit=crop&w=800&q=80"),
    ...
    ("Avicennia marina", "Grey Mangrove", "Plantae", "Acanthaceae", "Avicennia", "LC", "178828", False, True, "Pioneer mangrove species stabilizing intertidal mudflats.", "https://images.unsplash.com/photo-1518509562904-e7ef99cdcc86?auto=format&fit=crop&w=800&q=80"),
